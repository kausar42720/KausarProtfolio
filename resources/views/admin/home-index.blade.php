    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="{{route('admin.dashboard')}}"><img class="main-logo" src="{{asset('img')}}/logo/logo.png" alt="" /></a>
                <strong><img src="{{asset('img')}}/logo/logosn.png" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="{{route('admin.dashboard')}}"><img src="{{asset('img')}}/notification/4.jpg" alt="" /></a>
					<h2>Kausar <span class="min-dtn">Hosen</span></h2>
				</div>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                        <li class="active">
                            <a class="" href="{{asset('complitedproject')}}">
                                <i class="fa fa-hand-o-right"></i>
                                <span class="">Completed project list</span>
                            </a>
                            </
                        <li>
                        <li class="active">
                            <a class="" href="{{asset('contactMe')}}">
                                <i class="fa fa-hand-o-right"></i>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2018 <a href="">Development by Kausar Hosen</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
